                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-lg">
                        <div className="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full">
                            ...
                            <div className="grid grid-cols-4 gap-4 mb-4 max-h-56 overflow-y-auto custom-scrollbar">
                                {displayedWallets.map((wallet) => (
                                    <motion.button
                                        ...
                                        className={`flex flex-col items-center truncate justify-center p-2 rounded-lg ${wallet.readyState !== "Installed"
                            ...
                            <button
                                ...
                                className={`text-sm ${showAll ? "bg-gray-200 text-black/60" : "bg-black"
